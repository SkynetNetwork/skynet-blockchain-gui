...
import { useGetWalletBalanceQuery } from '@skynet/api-react';
import { TransactionType } from '@skynet/api';
import type { Transaction } from '@skynet/api';
import { syntToSkynet, blockHeightToTimestamp } from '@skynet/core';
  ...
  const points = [
    {
      ...
      y: Math.max(0, Number(syntToSkynet(start))),
      tooltip: syntToSkynet(balance),
    },
  ];
