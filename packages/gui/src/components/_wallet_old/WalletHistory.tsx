...
import { Card, CopyToClipboard, Flex, Table } from '@skynet/core';
import type { Row } from '../core/components/Table/Table';
import {
  synt_to_skynet_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? synt_to_colouredcoin_string(row.amount)
        : synt_to_skynet_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => synt_to_skynet_string(row.fee_amount),
