...
import { Flex, UnitFormat, More, Table, syntToSkynetLocaleString, Suspender } from '@skynet/core';
...
import { WalletStatus } from '@skynet/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={syntToSkynetLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
