...
import { CopyToClipboard, Flex, Link, Loading } from '@skynet/core';
import {
  Button,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@skynet/api-react';
import type { PlotNFT, PlotNFTExternal } from '@skynet/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/SkynetNetwork/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
