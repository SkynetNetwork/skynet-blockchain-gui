...
import { Plot as PlotIcon } from '@skynet/icons';
import { useDeleteUnconfirmedTransactionsMutation } from '@skynet/api-react';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: (
        <UnitFormat
          value={syntToSkynetLocaleString(balance)}
          state={State.SUCCESS}
        />
      ),
    },
