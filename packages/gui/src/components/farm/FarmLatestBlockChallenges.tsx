...
import { Link, Table, Card } from '@skynet/core';
import { useGetSignagePointsQuery, useGetCombinedPlotsQuery } from '@skynet/api-react';
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption">
        <Trans>
          *Want to explore Skynet’s blocks further? Check out{' '}
          <Link
            color="primary"
            href="https://www.skynetexplorer.com/"
            target="_blank"
          >
            Skynet Explorer
          </Link>{' '}
