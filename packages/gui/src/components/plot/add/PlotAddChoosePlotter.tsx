...
import { CardStep, Select, StateColor } from '@skynet/core';
import { useGetPlottersQuery } from '@skynet/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@skynet/api';
import type { Plotter, PlotterMap } from '@skynet/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    // Sort skynetpos to the top of the list
    displayablePlotters.sort((a, b) => a == PlotterName.SKYNETPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Skynet Proof of Space plotter. If unsure,
            use the default Skynet Proof of Space plotter.
        </Trans>
      </Typography>
