...
import { defaultPlotter } from '@skynet/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@skynet/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { useForm, SubmitHandler } from 'react-hook-form';
import { useShowError, ButtonLoading, Flex, Form, FormBackButton } from '@skynet/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    ...
    defaultValues: defaultsForPlotter(PlotterName.SKYNETPOS),
  });
