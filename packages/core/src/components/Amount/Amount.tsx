...
import skynetToSynt from '../../utils/skynetToSynt';
...
export type AmountProps = TextFieldProps & {
  children?: (props: { synt: number; value: string | undefined }) => ReactNode;
  name?: string;
};
        ...
        <FormHelperText component='div' >
          <Flex alignItems="center" gap={2}>
            <Flex flexGrow={1} gap={1}>
              {!!value && (
                <>
                  <FormatLargeNumber value={synt} />
                  <Box>
                    <Plural value={synt} one="synt" other="synts" />
                  </Box>
                </>
              )}
            </Flex>
