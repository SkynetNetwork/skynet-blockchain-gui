...
import icon from '../../assets/img/skynet_circle.svg';
...
const url = 'https://skynet-network.org';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Skynet Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/SkynetNetwork/skynet-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
